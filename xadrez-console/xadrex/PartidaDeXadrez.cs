...
namespace xadrez_console.xadrex
{
    public class PartidaDeXadrez
    {
        ...
        public void validarPosicaoDeOrigem(Posicao pos)
        {
            ...
            {
                throw new TabuleiroException("Não existem posicao de origem escolhida!");
            }
            ...
            {
                throw new TabuleiroException("Não há movimentos possiveis a peça de origem escolhida!");
            }
        }
